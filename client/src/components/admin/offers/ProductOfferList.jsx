...
const ProductOfferList = () => {
  ...
  const handleSearch = () => {
    setPage(1);
    dispatch(getAllProductOffers({ page: 1, search: searchTerm }));
  };

  const handleClearSearch = () => {
    setSearchTerm('');
    setPage(1);
    dispatch(getAllProductOffers({ page: 1 }));
  };
  ...
  const handleConfirmDelete = () => {
    dispatch(deleteProductOffer(selectedOfferId))
      .unwrap()
      .then(() => {
      ...
      {confirmDelete && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <h3 className="text-lg font-medium mb-4">Delete Product Offer</h3>
            <p className="text-gray-600 mb-6">
              Are you sure you want to delete this product offer? This action cannot be undone.
            </p>
