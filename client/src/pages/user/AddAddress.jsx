    ...
    <div className="bg-gray-50 min-h-screen pb-12">
      ...
      <div className="bg-black text-white">
        <div className="container mx-auto px-4 py-12">
          ...
          <p className="text-gray-300">Add a shipping or billing address to your account</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Fill in the information below to add a new address</p>
              </div>
            </div>
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2" htmlFor="addressLine1">
                Address Line 1
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-700 font-medium mb-2" htmlFor="addressLine2">
            ...
            <div className="flex items-center mt-4">
              ...
              />
              <label htmlFor="isDefault" className="ml-2 block text-gray-700 font-medium">
